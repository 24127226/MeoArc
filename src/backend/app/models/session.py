...
from app.core.crypto import EncryptedStr  # NFR-Security: cột token tự mã hoá khi lưu DB
...
class AuthSession(Base):
    ...
    #   Lưu DẠNG MÃ HOÁ nếu đã đặt TOKEN_ENCRYPTION_KEY (NFR-Security), còn không thì plaintext như cũ.

    google_refresh_token: Mapped[str | None] = mapped_column(EncryptedStr, nullable=True, default=None)
