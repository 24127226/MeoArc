...
engine = create_engine(
    ...
    # ── Connection pooling (NFR — Reliability/Memory, chỉ Postgres) ──
    # Giữ SẴN 20 kết nối + cho mượn thêm tối đa 10 lúc cao điểm (tránh mở/đóng liên tục = chậm & ngốn RAM DB).
    # pool_recycle=3600: tái tạo kết nối sau 1h để né việc Postgres/đường mạng tự ngắt kết nối "ngủ" quá lâu.
